...
--
-- Host: 127.0.0.1
-- Czas generowania: 14 Cze 2020, 23:03
...
CREATE TABLE `dane` (
  ...
  `kalorie` varchar(255) COLLATE utf8_polish_ci NOT NULL
...
INSERT INTO `dane` (`id`, `login`, `password`, `password2`, `data`, `Nazwa`, `kalorie`) VALUES
(1, 'testowe123', 'testowe123', 'testowe123', NULL, '0', ''),
(2, 'damianowe1', 'damianowe1', 'damianowe155', NULL, '0', ''),
(3, '', '', '', NULL, '0', ''),
(4, '', '', '', NULL, '0', ''),
(5, 'sylwia12', 'start123', 'start123', '2572', 'Agrest', '244'),
(6, 'rafal1', 'start1234', 'start1234', '1143', '0', '');
...
('Nazwa', 0, 'bialko', 'tluszcz', 'weglowodany'),
...
INSERT INTO `user` (`id`, `sylwia12`) VALUES
(1, 'cos tam');
